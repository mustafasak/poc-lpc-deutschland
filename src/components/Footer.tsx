    ...
    <footer className="bg-teal text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4">
              <span className="font-[800] text-xl leading-tight block">
                LES PETITS
              </span>
              <span className="font-[800] text-xl leading-tight block">
                CULOTTES
              </span>
              <span className="text-[10px] tracking-[0.2em] font-medium mt-1 block opacity-80">
                DEUTSCHLAND
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              <li>
                <Link href="/abo" className="hover:opacity-100">
                  Windel-Abo
                </Link>
              </li>
              <li>
